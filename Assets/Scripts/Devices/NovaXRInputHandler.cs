...
/// Supports both solid colors and gradient visual feedback
/// </summary>
public class NovaXRInputHandler : MonoBehaviour
{
    ...
    private void ProcessNovaInteraction()
    {
        ...
        bool hitNovaUI = CheckNovaUIHit(ray);
    ...
    private bool CheckNovaUIHit(Ray ray)
    {
        ...
        if (Physics.Raycast(ray, out hit, maxRayDistance))
        {
            ...
            var uiBlock = hit.collider.GetComponentInParent<Nova.UIBlock>();
            return uiBlock != null;
        }
        return false;
    }
